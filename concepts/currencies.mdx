...
InventPay supports five major cryptocurrencies across multiple blockchain networks, giving you and your customers flexibility in payment options.
...
<AccordionGroup>
  <Accordion title="For E-commerce" icon="cart-shopping">
    **Recommended:** `USDT_BEP20` or create multi-currency invoices
...
<Warning>
  **CRITICAL:** USDT_ERC20 and USDT_BEP20 use similar address formats but are on
  different networks. Sending to the wrong network will result in loss of funds!
</Warning>
...
<Steps>
  <Step title="Always Specify Network">
    When accepting USDT, clearly communicate which network (ERC-20 or BEP-20)
  </Step>
  ...
  <Step title="Test Both Networks">
    Test USDT on both ERC-20 and BEP-20 before going live
  </Step>
</Steps>
