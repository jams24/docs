...
const payment = await sdk.createPayment({
  amount: 29.99,
  amountCurrency: "USD",
  currency: "USDT_BEP20", // or BTC, ETH, LTC, XMR, USDT_ERC20, SOL, USDC_SOL, USDC_BEP20
  orderId: "order-12345",
...
// Output: ['BTC', 'ETH', 'LTC', 'XMR', 'USDT_ERC20', 'USDT_BEP20', 'SOL', 'USDC_SOL', 'USDC_BEP20']
```
...
| Solana   | Solana            | `SOL`        | Native Solana network       |
| USDC     | Solana            | `USDC_SOL`   | USDC on Solana              |
| USDC     | BSC (BEP-20)      | `USDC_BEP20` | USDC on Binance Smart Chain |
